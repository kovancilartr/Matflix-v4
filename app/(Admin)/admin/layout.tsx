...
import { DatabaseIcon, Home, Package, Users2 } from "lucide-react";
...
export default function AdminLayout({
  ...
  const navItems = [
    { name: "Ana Sayfa", url: "/", icon: <Home className="h-5 w-5" />},
    { name: "Yönetim Paneli", url: "/admin", icon: <DatabaseIcon className="h-5 w-5" />},
